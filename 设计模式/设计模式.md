...
![image-20201128201342978](https://gitee.com/maplefi/picture/blob/master/bed/image-20201128201342978.png)
...
**策略模式类似于五大原则中的开闭原则，开闭原则的扩展是说将里面常出现变化的地方进行抽象，策略模式和其类似，找到不同策略的共同点抽象出来然后达到随时替换的效果**
